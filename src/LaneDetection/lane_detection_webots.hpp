...
public:
    ...
    /**  @brief C++ implementation of lane detection pipeline
         @description Scales the image, does BEV transformation, Gray-scale conversion, Image thresholding, Sliding window lane tracking and lateral deviation calculation. Images are also stored in lane_out_img_dir, if RE_DRAW_IMAGE is defined.
         @param[in] src            Source image Matrix
         @param[in] world_encode   The Webots scene- 1: city_straight, 2: city_straight_night
