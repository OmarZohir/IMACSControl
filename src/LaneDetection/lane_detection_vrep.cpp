...
long double laneDetection::lane_detection_pipeline(Mat src_in){
    ...
    //string out_string = "/home/student/cppVrepLKAS/imacs/out_imgs"; //!< Path to store the images
    ...
    #endif
    bitwise_and(img_gray, img_gray, img_white_mask, mask); // extracts pixels above threshold=200; other pixels set to 0
