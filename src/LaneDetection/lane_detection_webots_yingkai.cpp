...
long double laneDetectionWEBOTS::lane_detection_pipeline(Mat src_in, int kfturn, int lane, int light, int imgcount)
{
...
/// <returns> .... </returns>
vector<vector<Point2f>> laneDetectionWEBOTS::get_bev_points(int kfturn, int lane)
{
    // declare variables
...
/// <param name="bar"> .... </param>
/// <returns> .... </returns>
void laneDetectionWEBOTS::bev_transform(Mat &src, Mat &dst, int kfturn, int lane)
{
...
/// <param name="bar"> .... </param>
/// <returns> .... </returns>
void laneDetectionWEBOTS::bev_rev_transform(Mat &src, Mat &dst, int kfturn, int lane)
{
    // get transform points
...
/// <param name="bar"> .... </param>
/// <returns> .... </returns>
long double laneDetectionWEBOTS::calculate_lateral_deviation(vector<Point> left_lane_inds, vector<Point> right_lane_inds, int kfturn, int lane, int light, int imgcount)
{
...
/// <param name="bar"> .... </param>
/// <returns> .... </returns>
vector<long double> laneDetectionWEBOTS::get_yL_container()
{
    return m_yL_container;
}

vector<long double> laneDetectionWEBOTS::get_ref_container()
{
