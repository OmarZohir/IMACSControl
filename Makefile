...
# Generated by qmake (2.01a) (Qt 4.8.7) on: za feb. 27 11:18:22 2021
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I. -I/usr/include/qt4 -I$(PWD)/externalApps/eigen -I$(PWD)/src/cpp_webots_api -I$(PWD)/include -I$(PWD)/include/auto_schedule -I$(PWD)/externalApps/Halide/include -I/usr/lib/x86_64-linux-gnu/pkgconfig -I$(PWD)/externalApps/Halide/tools -I$(PWD)/src/ReversiblePipeline/src -I$(PWD)/src/LaneDetection -I$(PWD)/src/LateralController -I$(PWD)/src/Profiling/demosaic-profiling/src -I/snap/webots/18/usr/share/webots/include/controller/cpp -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) $(PWD)/obj/imacs_webots1.0.0/ && $(COPY_FILE) --parents $(PWD)/src/LateralController/lateral_Control_WEBOTS.hpp $(PWD)/src/LaneDetection/lane_detection_webots.hpp $(PWD)/src/LaneDetection/image_signal_processing.hpp $(PWD)/include/polyfit.hpp $(PWD)/include/config_webots.hpp $(PWD)/include/paths.hpp $(PWD)/src/cpp_webots_api/webots_api.hpp $(PWD)/obj/imacs_webots1.0.0/ && $(COPY_FILE) --parents $(PWD)/src/main_IMACS_WEBOTS.cpp $(PWD)/src/cpp_webots_api/webots_api.cpp $(PWD)/src/LaneDetection/lane_detection_webots.cpp $(PWD)/src/LateralController/lateral_Control_WEBOTS.cpp $(PWD)/src/LaneDetection/image_signal_processing.cpp $(PWD)/src/ReversiblePipeline/src/LoadCamModel.cpp $(PWD)/src/ReversiblePipeline/src/MatrixOps.cpp $(PWD)/obj/imacs_webots1.0.0/ && (cd `dirname $(PWD)/obj/imacs_webots1.0.0` && $(TAR) imacs_webots1.0.0.tar imacs_webots1.0.0 && $(COMPRESS) imacs_webots1.0.0.tar) && $(MOVE) `dirname $(PWD)/obj/imacs_webots1.0.0`/imacs_webots1.0.0.tar.gz . && $(DEL_FILE) -r $(PWD)/obj/imacs_webots1.0.0
...
$(PWD)/obj/main_IMACS_WEBOTS.o: $(PWD)/src/main_IMACS_WEBOTS.cpp 
