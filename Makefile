...
# Generated by qmake (2.01a) (Qt 4.8.7) on: do feb. 25 14:26:33 2021
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) $(PWD)/obj/imacs_webots1.0.0/ && $(COPY_FILE) --parents $(PWD)/src/LateralController/lateral_Control_WEBOTS.hpp $(PWD)/src/LaneDetection/lane_detection_webots.hpp $(PWD)/src/LaneDetection/image_signal_processing.hpp $(PWD)/include/polyfit.hpp $(PWD)/src/cpp_webots_api/webots_api.hpp $(PWD)/obj/imacs_webots1.0.0/ && $(COPY_FILE) --parents $(PWD)/src/main_IMACS_WEBOTS.cpp $(PWD)/src/cpp_webots_api/webots_api.cpp $(PWD)/src/LaneDetection/lane_detection_webots.cpp $(PWD)/src/LateralController/lateral_Control_WEBOTS.cpp $(PWD)/src/LaneDetection/image_signal_processing.cpp $(PWD)/src/ReversiblePipeline/src/LoadCamModel.cpp $(PWD)/src/ReversiblePipeline/src/MatrixOps.cpp $(PWD)/obj/imacs_webots1.0.0/ && (cd `dirname $(PWD)/obj/imacs_webots1.0.0` && $(TAR) imacs_webots1.0.0.tar imacs_webots1.0.0 && $(COMPRESS) imacs_webots1.0.0.tar) && $(MOVE) `dirname $(PWD)/obj/imacs_webots1.0.0`/imacs_webots1.0.0.tar.gz . && $(DEL_FILE) -r $(PWD)/obj/imacs_webots1.0.0
